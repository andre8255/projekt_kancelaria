    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rok', models.CharField(blank=True, help_text='Np. 2005.', max_length=5, verbose_name='Rok bierzmowania')),
                ('akt_nr', models.CharField(blank=True, help_text='Numer aktu bierzmowania; jeśli nie podasz, może zostać wypełniony automatycznie.', max_length=5, verbose_name='Nr aktu bierzmowania')),
                ...
                ('imie_bierzmowania', models.CharField(blank=True, help_text='Imię przyjęte przy bierzmowaniu.', max_length=30, verbose_name='Imię bierzmowania')),
                ('miejsce_bierzmowania', models.CharField(blank=True, max_length=30, verbose_name='Miejsce bierzmowania')),
                ('parafia_nazwa_reczna', models.CharField(blank=True, help_text='Jeśli nie ma na liście powyżej.', max_length=60, verbose_name='Parafia (opis ręczny)')),
                ('szafarz_opis_reczny', models.CharField(blank=True, help_text='Np. „bp Jan Kowalski”, „ks. Piotr Nowak”.', max_length=50, verbose_name='Szafarz (opis ręczny)')),
                ('swiadek', models.CharField(blank=True, help_text='Imię i nazwisko świadka.', max_length=50, verbose_name='Świadek bierzmowania')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('akt_nr', models.CharField(help_text='Numer aktu chrztu w danym roku; jeśli nie podasz, wypełni się automatycznie.', max_length=5, verbose_name='Nr aktu')),
                ...
                ('miejsce_urodzenia', models.CharField(blank=True, max_length=30, verbose_name='Miejsce urodzenia')),
                ...
                ('miejsce_chrztu', models.CharField(blank=True, max_length=30, verbose_name='Miejsce chrztu')),
                ('ojciec', models.CharField(blank=True, max_length=30, verbose_name='Ojciec (imię i nazwisko)')),
                ('matka', models.CharField(blank=True, max_length=30, verbose_name='Matka (imię i nazwisko)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rok', models.CharField(blank=True, help_text='Np. 2014. Możesz wpisać tylko rok.', max_length=5, verbose_name='Rok ślubu')),
                ('akt_nr', models.CharField(blank=True, help_text='Numer aktu w księdze małżeństw.', max_length=5, verbose_name='Nr aktu małżeństwa')),
                ('data_slubu', models.DateField(blank=True, help_text='Pełna data (dzień-miesiąc-rok).', null=True, verbose_name='Data ślubu (pełna)')),
                ('parafia_opis_reczny', models.CharField(blank=True, help_text='Jeśli nie ma parafii na liście powyżej, wpisz tutaj.', max_length=60, verbose_name='Parafia ślubu (opis ręczny)')),
                ('swiadek_urzedowy_opis_reczny', models.CharField(blank=True, help_text='Kapłan/diakon, który asystował przy zawarciu małżeństwa.', max_length=60, verbose_name='Świadek urzędowy / asystujący (opis ręczny)')),
                ('swiadek_a', models.CharField(blank=True, max_length=50, verbose_name='Świadek A')),
                ('swiadek_b', models.CharField(blank=True, max_length=50, verbose_name='Świadek B')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('miejsce', models.CharField(blank=True, help_text='Np. dom chorego, szpital.', max_length=50, verbose_name='Miejsce')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rok', models.CharField(blank=True, help_text='Np. 1998.', max_length=5, verbose_name='Rok I Komunii')),
                ('uwagi_wew', models.TextField(blank=True, verbose_name='Uwagi kancelaryjne (wewnętrzne)')),
                ...
                ('parafia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='komunie', to='slowniki.parafia', verbose_name='Parafia I Komunii św.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rok', models.CharField(blank=True, help_text='Np. 2024.', max_length=5, verbose_name='Rok zgonu / księgi')),
                ('akt_nr', models.CharField(blank=True, help_text='Numer aktu w księdze zgonów.', max_length=5, verbose_name='Nr aktu zgonu')),
                ('data_zgonu', models.DateField(blank=True, null=True, verbose_name='Data zgonu')),
                ('miejsce_zgonu', models.CharField(blank=True, max_length=50, verbose_name='Miejsce zgonu')),
                ('data_pogrzebu', models.DateField(blank=True, null=True, verbose_name='Data pogrzebu')),
                ('cmentarz', models.CharField(blank=True, max_length=50, verbose_name='Cmentarz')),
                ('uwagi_wew', models.TextField(blank=True, verbose_name='Uwagi kancelaryjne (wewnętrzne)')),
