    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('miejsce_bierzmowania', models.CharField(blank=True, help_text='Miejsce bierzmowania', max_length=100, verbose_name='Miejsce bierzmowania')),
                ...
                ('szafarz', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bierzmowania', to='slowniki.duchowny', verbose_name='Szafarz (udzielający bierzmowania)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_slubu', models.DateField(blank=True, null=True, verbose_name='Data ślubu (pełna)')),
                ...
                ('swiadek_a', models.CharField(blank=True, max_length=200, verbose_name='Świadek A (np. małżonka)')),
                ('swiadek_b', models.CharField(blank=True, max_length=200, verbose_name='Świadek B (np. małżonka)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parafia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='komuni', to='slowniki.parafia', verbose_name='Parafia I komuni św.')),
            ],
            options={
